...
# The output displays - Starting Wrapper and Ending Wrapper instead of the actual function name.
# This can be corrected using functools.wrap
# Passing an argument to the log decorator.
