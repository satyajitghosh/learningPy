...
#In this iteration, we try to make the design pattern more functional.
...
def lifo_ordering(list:List[SupportTicket])->List[SupportTicket]:
    list_copy = list.copy()
    list_copy.reverse()
    return list_copy
...
class CustomerSupport:
    ...
    def process_tickets(self,process_strategy_func:Callable[[List[SupportTicket]],List[SupportTicket]]):
        # if it's empty, don't do anything

        tickets_list = process_strategy_func(self.tickets)
...
# process the tickets
app.process_tickets(lifo_ordering)