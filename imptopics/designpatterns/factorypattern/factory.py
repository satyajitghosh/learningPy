...
# One more thing we can do is remove the read_factory par from main.
# This is done by passing an Exporter factory object to main.
# And, since ExpoterFactory is an abstract base class.
# this notonly leads to dependency injection, but also dependency inversion.
...
def main(exporter_factory:ExporterFactory) -> None:
    """Main function."""
